              ...
              <div class="white-box">
                  <h2 class="box-title m-b-0">Full access admin</h2>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-8 text-right"><button type="submit" class="btn btn-info"><i class="fa fa-trash-o"></i> Delete</button>
                                </div>
                          </div>
                          </div>
                          <hr>
                          ...
                          <div class="form-group" style="margin-top:15px; margin-bottom: 25px;">
                              <div class="input-group">
                                <div class="col-md-8 col-xs-12 text-right"><button type="submit" onclick="window.location.href='create-admin'" class="btn btn-default btn-outline"><i class="fa fa-plus-circle"></i> Add new</button></div>
                              </div>
                          </div>
