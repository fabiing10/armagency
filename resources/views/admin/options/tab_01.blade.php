                                    ...
                                    <div class="form-group">
                                        <label>
                                            <div class="radio radio-success">
                                                ...
                                                <br>
                                                <input type="checkbox" name="g_l_claims_made" value="true"> Claims made
                                                <br>
                                    ...
                                    <div class="form-group">
                                        <label>
                                            <div class="radio radio-success">
                                                ...
                                                <br>
                                                <input type="checkbox" name="g_l_project" value="true"> Project
                                                <br>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="radio radio-success">
                                            <input type="checkbox" name="a_l_any_auto" value="true"> Any auto
                                            <br>
                                            <input type="checkbox" name="a_l_all_owned" value="true"> All owned autos
                                            <br>
                                            <input type="checkbox" name="a_l_sheduled" value="true"> Scheduled autos
                                            <br>
                                            <input type="checkbox" name="a_l_home_autos" value="true"> Home autos
                                            <br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="radio radio-success">
                                            <input type="checkbox" name="a_l_hired_autos" value="true"> Hired autos
                                            <br>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="radio radio-success">
                                            <input type="checkbox" name="u_l_umbrella_liability" value="true">Umbrella liability
                                            <br>
                                            <input type="checkbox" name="u_l_occur" value="true"> Occur
                                            <br>
                                            <input type="checkbox" name="u_l_excess_liability" value="true"> Excess liability
                                            <br>
                                            <input type="checkbox" name="u_l_claims_made" value="true">Claims-made
                                            <br>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="radio radio-success">
                                            <input type="checkbox" name="u_l_deductible" value="true"> Deductible
                                            <br>
