      ...
      <div class="sidebar-nav slimscrollsidebar">
          <div class="sidebar-head">
              ...
              <ul class="nav" id="side-menu">
                  ...
                  <li><a href="/admin/create-certificate" class="waves-effect px-25"><i class="fa fa-plus-circle"></i> <span class="hide-menu" style="padding-left: 20px;"> Create new </span></a>
                  </li>
